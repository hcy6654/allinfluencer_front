...
import { formatDate, getRoleBadge, getRoleLabel, getStatusBadge, getStatusLabel } from '../lib/utils';
        ...
        <div className="bg-white rounded-lg shadow-sm border hover:shadow-md transition-shadow p-4">
            <div className="flex items-center space-x-4">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    {user.bio && <p className="text-sm text-gray-600 line-clamp-1 mb-2">{user.bio}</p>}
                </div>
